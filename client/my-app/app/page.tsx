...
//         let streamedContent = "";
//         let searchData: Record<string, any> | null = null;
...
//                 setMessages(prev =>
//                   prev.map(msg =>
//                     msg.id === aiResponseId? { ...msg, searchInfo: finalSearchInfo, isLoading: false }
//                       : msg
//                   )
//                 );
//               }
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (currentMessage.trim()) {
      ...
      try {
        ...
        // Listen for end event (optional, in case backend emits a custom "end" event)
        eventSource.addEventListener("end", () => {
          eventSource.close();
        });
      } catch (error) {
